  ...
  return (
    <div className="container-fluid px-0 pb-3">
      ...
      {cargando ? <div className="card border-0 shadow-sm"><div className="card-body text-center py-5"><div className="spinner-border text-primary mb-2" role="status" /><div className="text-muted">Cargando tipos...</div></div></div> : <>
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between gap-1 small text-muted mb-2"><span>Mostrando <strong>{desde} - {hasta}</strong> de <strong>{filtrados.length}</strong> tipos</span><span>Total: <strong>{tipos.length}</strong> | Activos: <strong>{activos}</strong> | Inactivos: <strong>{inactivos}</strong></span></div>
