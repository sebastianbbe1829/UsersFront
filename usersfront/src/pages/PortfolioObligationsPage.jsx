...
export default function PortfolioObligationsPage() {
  ...
  useEffect(() => {
    ...
    void Promise.all([cargar(), cargarClientes()])
    return undefined
  }, [token, cargar, cargarClientes])
        ...
        <div className="card-body">
          <div className="row g-3 align-items-end">
            ...
            <div className="col-lg-3 d-flex justify-content-end">
              <button type="button" className="btn btn-outline-secondary" onClick={() => void limpiarFiltros()} disabled={cargando || (!clientId && !dateFrom && !dateTo)}>Limpiar</button>
            </div>
          </div>
      ...
      <div className="card border-0 shadow-sm">
        <div className="table-responsive">
          <table className="table table-hover align-middle mb-0">
            <thead><tr><th>Cliente</th><th>Venta</th><th>Fecha</th><th className="text-end">Valor inicial</th><th className="text-end">Saldo</th><th>Estado</th></tr></thead>
            <tbody>
