...
export default function SalesCheckoutPage() {
  ...
  const reset = () => { setCart([]); setSearch(''); setMode('generic'); setParticipants([]); setClientSearch(''); setDiscount('0'); setPayments([{ method: 'EFECTIVO', amount: '' }]); setLastSale(null); setMessage(null) }
