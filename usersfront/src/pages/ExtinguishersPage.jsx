...
function ExtinguishersPage() {
  ...
  const exportarExcel = async () => {
    try {
      ...
      setMensaje({
        tipo: 'danger',
        texto: 'No fue posible exportar los extintores.',
      })
    } finally {
      setExportando(false)
    }
  ...
  const abrirRevisiones = (e) =>
    navigate(`../extintores/revisiones?extinguisher_id=${e.id}`)
  ...
  const renderAcciones = (e, mobile = false) => (
    <div className={mobile ? 'd-grid gap-1' : 'd-flex justify-content-center gap-1'}>
      ...
      <button
        type="button"
        className={`btn ${mobile ? 'btn-primary' : 'btn-info'} btn-sm`}
        title="Revisiones"
    ...
    <div>
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-4">
        ...
        <div className="d-flex align-items-center gap-2 flex-wrap">
          ...
          <button
            ...
            disabled={exportando}
            title="Exportar todos los extintores a Excel"
          >
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mt-3">
            ...
            <div>
              ...
              <div className="small text-muted">
                Total: <strong>{extintores.length}</strong> | Activos:{' '}
                <strong>{activos}</strong> | Inactivos:{' '}
            ...
            <div className="row g-3">
              ...
              <div className="col-12 col-md-6">
                ...
                <input
                  ...
                  value={formulario.last_recharge_date}
                  onChange={cambiarCampo}
                />
              </div>
              ...
              <div className="col-12 col-md-6">
                ...
                <input
                  ...
                  value={formulario.next_recharge_date}
                  onChange={cambiarCampo}
                />
              </div>
              ...
              <div className="col-12 col-md-6">
                ...
                <input
                  ...
                  value={formulario.last_hydrostatic_test_date}
                  onChange={cambiarCampo}
                />
              </div>
              ...
              <div className="col-12 col-md-6">
                ...
                <input
                  ...
                  value={formulario.next_hydrostatic_test_date}
                  onChange={cambiarCampo}
                />
              </div>
      ...
      {eliminandoItem && (
        <Modal
          ...
          onClose={() =>
            !eliminando && setEliminandoItem(null)
          }
          footer={
            <>
              <button
                type="button"
                className="btn btn-secondary"
                onClick={() => setEliminandoItem(null)}
                disabled={eliminando}
              >
                Cancelar
              </button>
        ...
        >
          <p className="mb-0">
            ...
            <strong>{eliminandoItem.code}</strong>?
          </p>
        </Modal>
      )}
