...
import { EmptyState, Pagination, SearchBar, TableTypes, TypeModal } from './InventoryShared'
...
function InventoryTypesPage() {
  ...
  return <>
    ...
    <div className="card shadow-sm border-0"><div className="card-body">
      ...
      {!cargando && filtrados.length > 0 && <><TableTypes rows={filas} onEdit={editar} /><Pagination total={filtrados.length} page={page} pageSize={pageSize} onPageChange={setPage} /></>}
    </div></div>
