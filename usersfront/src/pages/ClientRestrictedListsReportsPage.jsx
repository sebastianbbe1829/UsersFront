...
function ClientRestrictedListsReportsPage() {
  ...
  const filtrados = useMemo(() => {
    ...
    return registros.filter((item) => [
      ...
      item.report_status, item.compliance_status, item.list_type, item.list_name,
      item.client_created_by, item.screening_status, item.screening_risk_level,
