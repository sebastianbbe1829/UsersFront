    ...
    <div className={modoOscuro ? 'bg-dark text-light min-vh-100' : 'bg-light min-vh-100'} style={{ display: 'flex' }}>
      <aside className={modoOscuro ? 'bg-black text-light shadow' : 'bg-dark text-white shadow'} style={{ width: menuColapsado ? '72px' : '250px', minHeight: '100vh', transition: 'width 0.25s ease', position: 'fixed', left: 0, top: 0, bottom: 0, zIndex: 1000, overflow: 'hidden' }}>
        ...
        <nav className="d-flex flex-column">
          ...
          <button type="button" className={obtenerClaseMenu(location.pathname.includes('/extintores'))} onClick={() => setExtintoresAbiertos((valor) => !valor)} title="Extintores" style={{ background: 'transparent' }}>
            <span style={{ fontSize: '21px', minWidth: '24px', textAlign: 'center' }}>🧯</span>
            {!menuColapsado && <><span className="ms-3 flex-grow-1 text-start">Extintores</span><span>{extintoresAbiertos ? '▾' : '▸'}</span></>}
          </button>

          {extintoresAbiertos && !menuColapsado && (
            <div className="ps-3">
              <NavLink to="extintores" end className={({ isActive }) => obtenerClaseMenu(isActive)} title="Extintores" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '19px', minWidth: '24px', textAlign: 'center' }}>🧯</span><span className="ms-3">Inventario</span></NavLink>
              <NavLink to="extintores/tipos" className={({ isActive }) => obtenerClaseMenu(isActive)} title="Tipos de extintores" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '19px', minWidth: '24px', textAlign: 'center' }}>🏷️</span><span className="ms-3">Tipos de extintores</span></NavLink>
            </div>
          )}

          {menuColapsado && extintoresAbiertos && <div className="border-top border-secondary border-bottom border-secondary"><NavLink to="extintores" end className={({ isActive }) => obtenerClaseMenu(isActive)} title="Extintores" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '20px', minWidth: '24px', textAlign: 'center' }}>🧯</span></NavLink><NavLink to="extintores/tipos" className={({ isActive }) => obtenerClaseMenu(isActive)} title="Tipos de extintores" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '20px', minWidth: '24px', textAlign: 'center' }}>🏷️</span></NavLink></div>}
          ...
          {administracionAbierta && !menuColapsado && <div className="ps-3"><NavLink to="usuarios" className={({ isActive }) => obtenerClaseMenu(isActive)} title="Usuarios" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '19px', minWidth: '24px', textAlign: 'center' }}>👥</span><span className="ms-3">Usuarios</span></NavLink><NavLink to="roles" className={({ isActive }) => obtenerClaseMenu(isActive)} title="Roles" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '19px', minWidth: '24px', textAlign: 'center' }}>🛡️</span><span className="ms-3">Roles</span></NavLink><NavLink to="permisos" className={({ isActive }) => obtenerClaseMenu(isActive)} title="Permisos" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '19px', minWidth: '24px', textAlign: 'center' }}>🔐</span><span className="ms-3">Permisos</span></NavLink></div>}
          {menuColapsado && administracionAbierta && <div className="border-top border-secondary border-bottom border-secondary"><NavLink to="usuarios" className={({ isActive }) => obtenerClaseMenu(isActive)} title="Usuarios" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '20px', minWidth: '24px', textAlign: 'center' }}>👥</span></NavLink><NavLink to="roles" className={({ isActive }) => obtenerClaseMenu(isActive)} title="Roles" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '20px', minWidth: '24px', textAlign: 'center' }}>🛡️</span></NavLink><NavLink to="permisos" className={({ isActive }) => obtenerClaseMenu(isActive)} title="Permisos" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '20px', minWidth: '24px', textAlign: 'center' }}>🔐</span></NavLink></div>}

          {esSuper && <NavLink to="configuracion-ui" className={({ isActive }) => obtenerClaseMenu(isActive)} title="Configuración de la interfaz" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '21px', minWidth: '24px', textAlign: 'center' }}>🎨</span>{!menuColapsado && <span className="ms-3">Configuración UI</span>}</NavLink>}
          {esSuper && <NavLink to="administracion-tenant" className={({ isActive }) => obtenerClaseMenu(isActive)} title="Administración del tenant" style={({ isActive }) => isActive ? { backgroundColor: primaryColor } : undefined}><span style={{ fontSize: '21px', minWidth: '24px', textAlign: 'center' }}>🏢</span>{!menuColapsado && <span className="ms-3">Administración del tenant</span>}</NavLink>}
        </nav>
